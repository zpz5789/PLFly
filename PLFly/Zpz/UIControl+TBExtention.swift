...
public extension TBPOP where Base: UIControl {
...
fileprivate extension UIControl  {
    ...
    private var hitTime: Double? {
        get { return tb_getAssociatedObject(self, &hitTimerKey) }
        set { tb_setRetainedAssociatedObject(self, &hitTimerKey, newValue, .OBJC_ASSOCIATION_ASSIGN) }
    }
    ...
    @objc func c_preventDoubleHit(_ base: UIControl)  {
        ...
        TBAsyncs.asyncDelay(hitTime ?? 1.0) {
        } _: {
