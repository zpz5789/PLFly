...
extension UIFont: TBPOPCompatible {}

// MARK: - 一、常用的系统基本字体扩展
public extension TBPOP where Base: UIFont {
...
/*
 ...
 3、调用下面方法使用：UIFont.tb.customFont(26, fontName: "字体的名字")
 */
public extension TBPOP where Base: UIFont {
    //MARK: 3.1、自定义字体
    /// 自定义字体
...
//MARK: - private
private extension TBPOP where Base: UIFont {
    /// 自定义的字体
    /// - Parameters:
    ///   - fontName: 字体的名字
    ///   - ofSize: 字体大小
