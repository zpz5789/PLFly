...
extension Float: TBPOPCompatible {}
// MARK: - 一、Float 与其他类型的转换
public extension TBPOP where Base == Float {
...
public extension TBPOP where Base == Float {
    ...
    func rounding(scale: Int16 = 1) -> Float {
        let value = NSDecimalNumberHandler.tb.rounding(value: self.base, scale: scale)
