//
//  CAGradientLayer+TBExtension.swift
//  PLFly
//
...
extension CAGradientLayer: TBPOPCompatible {}

// MARK: - 一、基本的扩展
public enum TBViewGradientDirection {
    /// 水平从左到右
    case horizontal
    ///  垂直从上到下
    case vertical
...
public extension TBPOP where Base: CAGradientLayer {
    ...
    func gradientLayer(_ direction: TBViewGradientDirection = .horizontal, _ gradientColors: [Any], _ gradientLocations: [NSNumber]? = nil, _ transform: CATransform3D? = nil) -> CAGradientLayer {
