//
//  NSDecimalNumberHandler+TBExtention.swift
//  PLFly
//
 ...
 */
extension NSDecimalNumberHandler: TBPOPCompatible {}
...
// MARK: - 一、基本的扩展
public extension TBPOP where Base: NSDecimalNumberHandler {
    ...
    static func isDivisible(value1: Any, value2: Any) -> Bool {
        ...
        let valueArray = value.tb.separatedByString(with: ".")
        // 没有小数代表是整除
