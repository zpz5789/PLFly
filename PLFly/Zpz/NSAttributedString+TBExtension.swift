//
//  NSAttributedString+TBExtension.swift
//  PLFly
//
...
extension NSAttributedString: TBPOPCompatible {}

// MARK: - 一、文本设置的基本扩展
public extension TBPOP where Base: NSAttributedString {
    ...
    func setSpecificRangeDeleteLine(color: UIColor, range: NSRange) -> NSAttributedString {
        ...
        let version = UIDevice.tb.currentSystemVersion as NSString
